...
from meeting.einteilung import Einteilung
...
urlpatterns = patterns(
    ...
    url(r'^(?P<meeting_id>\d+)/wettkaempfe/(?P<wettkampf_info>.+?)/(?P<kategorie_name>.+?)/einteilung/$', Einteilung.as_view(), name='einteilung'),
