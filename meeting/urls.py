...
from meeting.wettkampf import WettkampfList
from meeting.wettkampf import WettkampfDetails
...
urlpatterns = patterns(
    ...
    url(r'^(?P<meeting_id>\d+)/wettkampf/$', WettkampfList.as_view(), name='wettkaempfe'),
    url(r'^(?P<meeting_id>\d+)/wettkampf/(?P<wettkampf_info>.+?)/(?P<kategorie_name>.+?)/$', WettkampfDetails.as_view(), name='wettkampf-details'),
    url(r'^(?P<meeting_id>\d+)/wettkampf/(?P<wettkampf_info>.+?)/(?P<kategorie_name>.+?)/gruppen-einteilung/$', GruppenEinteilung.as_view(), name='gruppen-einteilung'),
