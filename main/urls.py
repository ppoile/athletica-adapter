...
urlpatterns = patterns(
    ...
    url(r'^meeting/(?P<meeting_id>\d+)/wettkaempfe/(?P<wettkampf_info>.+?)/(?P<kategorie_name>.+?)/rangliste/$', views.rangliste, name='rangliste'),
    url(r'^meeting/(?P<meeting_id>\d+)/wettkaempfe/(?P<wettkampf_info>.+?)/(?P<kategorie_name>.+?)/rangliste-odt/$', views.rangliste_odt, name='rangliste-odt'),
